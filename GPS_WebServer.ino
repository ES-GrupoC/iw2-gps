...
char ssid[] = "GPS ES";        // your network SSID (name)
char pass[] = "es202122";      // your network password (use for WPA, or use as key for WEP)
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<title>IntelWheels2Location</title>");
          client.println("</head>");
          client.println("<style>");
          client.println("body {");
          client.println("background-image: url(\"https://docs.google.com/uc?id=1j4JV5DVqUBq_hvyuRCSBIR6FwWf9PiZR\");");
          client.println("background-repeat: no-repeat;");
          client.println("background-size: 40%;");
          client.println("background-position: center;");
          client.println("background-position-y: 180px;");
          client.println("}");
          client.println(".title{");
          client.println("text-align: center;");
          client.println("font-family: Georgia, serif;");
          client.println("color: rgb(3, 77, 40);");
          client.println("}");
          client.println("* {");
          ...
          client.println("width: 33%;");
          client.println("}");
          client.println(".middle {");
          client.println("width: 33%;");
          client.println("}");
          ...
          client.println("h2{");
          client.println("font-family: Georgia, serif;");
          client.println("color: rgb(2, 134, 68);");
          client.println("}");
          client.println("p{");
          client.println("font-family: Georgia, serif;");
          client.println("color: rgb(2, 134, 68);");
          ...
          client.println("</style>");
          client.println("<body>");
          client.println("<div class=\"title\"><h1>Localização da IntelWheels2</h1></div>");
          client.println("<div class=\"row\">");
          client.println("<div class=\"column left\">");
          client.println("<h2>Latitude</h2>");
          client.println("<p>");
          client.println(lat);
          client.println("º");
          client.println("</p>");
          ...
          client.println("<h2>Longitude</h2>");
          client.println("<p>");
          client.println(lon);
          client.println("º");
          client.println("</p>");
